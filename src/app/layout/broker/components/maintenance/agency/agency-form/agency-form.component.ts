...
export class AgencyFormComponent implements OnInit {
  ...
  private getLastBrokerList(idProducto, page) {
    this.foundResultsPension =
      this.pensionID.id == idProducto ? [] : this.foundResultsPension;
    this.foundResultsSalud =
      this.saludID.id == idProducto ? [] : this.foundResultsSalud;
    this.agencyService
      .getLastBrokerList(
        this.contractor.Id,
        CommonMethods.branchXproduct(this.codProducto),
        idProducto,
        this.itemsPerPage,
        page
      )
      .subscribe(
        (res) => {
          this.totalItemsPension =
            this.pensionID.id == idProducto
              ? res.TotalRowNumber
              : this.totalItemsPension;
          this.totalItemsSalud =
            this.saludID.id == idProducto
              ? res.TotalRowNumber
              : this.totalItemsSalud;
  ...
  changeValidators(type) {
    ...
    if (type == 2) {
      let response = CommonMethods.selTipoDocumento(
        this.contractorFormGroup.controls.documentType.value
      );
    ...
    if (type == 3) {
      ...
      if (this.contractorFormGroup.controls.searchMode.value == '1') {
        if (this.contractorFormGroup.controls.documentType.value == '2') {
          this.contractorFormGroup.controls.documentNumber.setValidators([
            Validators.required,
            Validators.maxLength(8),
            Validators.minLength(8),
            Validators.pattern(GlobalValidators.getDniPattern()),
          ...
          this.contractorFormGroup.controls.documentType.value == '1'
        ) {
          //Ruc
          this.contractorFormGroup.controls.documentNumber.setValidators([
            Validators.required,
          ...
          this.contractorFormGroup.controls.documentType.value == '4' ||
          this.contractorFormGroup.controls.documentType.value == '6'
        ) {
          //ce o pasaporte
          this.contractorFormGroup.controls.documentNumber.setValidators([
            Validators.required,
        ...
        if (this.contractorFormGroup.controls.personType.value == '1') {
          this.contractorFormGroup.controls['firstName'].setValidators([
            Validators.required,
            Validators.minLength(2),
            Validators.maxLength(19),
            Validators.pattern(GlobalValidators.getLatinTextPattern()),
            GlobalValidators.vowelLimitValidation,
            GlobalValidators.consonantLimitValidation,
          ]);
          this.contractorFormGroup.controls.firstName.updateValueAndValidity();
          this.contractorFormGroup.controls['paternalLastName'].setValidators([
            Validators.required,
            Validators.minLength(2),
            Validators.maxLength(19),
            Validators.pattern(GlobalValidators.getLatinTextPattern()),
          ...
          this.contractorFormGroup.controls.paternalLastName.updateValueAndValidity();
          this.contractorFormGroup.controls['maternalLastName'].setValidators([
            Validators.maxLength(19),
            Validators.pattern(GlobalValidators.getLatinTextPattern()),
            GlobalValidators.vowelLimitValidation,
            GlobalValidators.consonantLimitValidation,
          ...
          this.contractorFormGroup.controls['legalName'].setValidators([
            Validators.required,
  ...
  private initializeForm() {
    this.mainFormGroup.controls.saludAgencyDate.setValue(
      new Date(
    ...
    this.mainFormGroup.controls.pensionAgencyDate.setValue(
      new Date(
        new Date().getFullYear(),
        new Date().getMonth(),
        new Date().getDate()
  ...
  sctrSaludStateChanged() {
    if (this.isSctrSaludSelected) {
      ...
      this.mainFormGroup.controls.saludAgencyDate.setValidators([
        Validators.required,
  ...
  sctrPensionStateChanged() {
    if (this.isSctrPensionSelected) {
      ...
      this.mainFormGroup.controls.pensionAgencyDate.setValidators([
        Validators.required,
        GlobalValidators.tooOldDateValidator,
        GlobalValidators.notValidDate,
      ]);
  ...
  documentNumberKeyPress(event: any) {
    ...
    CommonMethods.validarNroDocumento(
      event,
      this.contractorFormGroup.controls.documentType.value
    );
  }
  ...
  searchContractor() {
    ...
    if (this.contractorFormGroup.valid) {
      ...
      if (this.contractorFormGroup.controls.documentNumber.valid == false) {
        if (
          this.contractorFormGroup.controls.documentNumber.hasError('required')
        )
      ...
      if (this.contractorFormGroup.controls.firstName.valid == false) {
        if (this.contractorFormGroup.controls.firstName.hasError('required'))
      ...
      if (this.contractorFormGroup.controls.paternalLastName.valid == false) {
        if (
          this.contractorFormGroup.controls.paternalLastName.hasError(
            'required'
          )
        )
      ...
      if (this.contractorFormGroup.controls.maternalLastName.valid == false) {
        if (
          this.contractorFormGroup.controls.maternalLastName.hasError(
            'required'
          )
        )
          errorList.push('El apellido materno es requerido.');
        else errorList.push('El apellido materno no es válido.');
      }
      if (this.contractorFormGroup.controls.legalName.valid == false) {
        if (this.contractorFormGroup.controls.legalName.hasError('required'))
  ...
  processSearchContractor() {
    ...
    if (this.contractorFormGroup.controls.searchMode.value == '1') {
      data.P_NIDDOC_TYPE =
        this.contractorFormGroup.controls.documentType.value.toString();
      data.P_SIDDOC = this.contractorFormGroup.controls.documentNumber.value;
    } else {
      if (this.contractorFormGroup.controls.personType.value == '1') {
        data.P_NIDDOC_TYPE = '';
        data.P_SIDDOC = '';
        data.P_SFIRSTNAME = this.contractorFormGroup.controls.firstName.value
          .toString()
          .toUpperCase();
        data.P_SLASTNAME =
          this.contractorFormGroup.controls.paternalLastName.value
            .toString()
            .toUpperCase();
        data.P_SLASTNAME2 =
          this.contractorFormGroup.controls.maternalLastName.value == null
            ? ''
            : this.contractorFormGroup.controls.maternalLastName.value
                .toString()
                .toUpperCase();
        data.P_SLEGALNAME = '';
      } else {
        data.P_NIDDOC_TYPE = '';
        data.P_SIDDOC = '';
        data.P_SLEGALNAME = this.contractorFormGroup.controls.legalName.value
          .toString()
          .toUpperCase();
        data.P_SFIRSTNAME = '';
        data.P_SLASTNAME = '';
          ...
          if (res.EListClient != null && res.EListClient.length > 0) {
            if (res.EListClient.length != 1) {
              ...
              modalRef.result.then(
                (item) => {
                  if (item != null) {
                    ...
                    if (
                      item.EListAddresClient != null &&
                      item.EListAddresClient.length > 0
                    )
                      this.contractor.Address =
                        item.EListAddresClient[0].P_SSTREET +
                        ', ' +
                        item.EListAddresClient[0].P_DESDISTRITO +
                        ', ' +
                        item.EListAddresClient[0].P_DESPROVINCIA +
                        ', ' +
                        item.EListAddresClient[0].P_DESDEPARTAMENTO;
                    else this.contractor.Address = 'No registrado';

                    if (
                      item.EListPhoneClient != null &&
                      item.EListPhoneClient.length > 0
                    )
                      this.contractor.Phone = item.EListPhoneClient[0].P_SPHONE;
                    else this.contractor.Phone = 'No registrado';

                    if (
                      item.EListEmailClient != null &&
                      item.EListEmailClient.length > 0
                    )
                      this.contractor.Email =
                        item.EListEmailClient[0].P_SE_MAIL;
                    ...
                    if (item.P_NIDDOC_TYPE == '1') {
                      ...
                      this.documentTypeList.map(function (element) {
                        if (element.Id == item.P_NIDDOC_TYPE)
                          self.contractor.DocumentType = element.Name;
                      });
                    ...
                    this.getLastBrokerList(
                      this.pensionID.id,
                      this.currentPagePension
                    );
                    this.getLastBrokerList(
                      this.saludID.id,
                      this.currentPageSalud
                    );
                  }
                },
                (reason) => {}
              ...
              if (
                ...
                this.contractor.Address =
                  res.EListClient[0].EListAddresClient[0].P_SSTREET +
                  ', ' +
                  res.EListClient[0].EListAddresClient[0].P_DESDISTRITO +
                  ', ' +
                  res.EListClient[0].EListAddresClient[0].P_DESPROVINCIA +
                  ', ' +
                  res.EListClient[0].EListAddresClient[0].P_DESDEPARTAMENTO;
              else this.contractor.Address = 'No registrado';
              ...
              if (res.EListClient[0].P_NIDDOC_TYPE == '1') {
                ...
                this.documentTypeList.map(function (item) {
                  if (item.Id == res.EListClient[0].P_NIDDOC_TYPE)
                    self.contractor.DocumentType = item.Name;
                });

                this.contractor.FullName =
                  res.EListClient[0].P_SLASTNAME +
                  ' ' +
                  res.EListClient[0].P_SLASTNAME2 +
                  ' ' +
                  res.EListClient[0].P_SFIRSTNAME;
              }
  ...
  tryToProcessPensionAgency(
    salud_ErrorList: string[],
    salud_SuccessList: string[]
  ) {
    let self = this;
    ...
    pensionAgencyData.AgencyDate =
      this.mainFormGroup.controls.pensionAgencyDate.value;
    pensionAgencyData.ChannelTypeId = this.channelTypeId;
    pensionAgencyData.User = JSON.parse(localStorage.getItem('currentUser'))[
      'id'
    ];
    pensionAgencyData.ProductId = JSON.parse(localStorage.getItem('pensionID'))[
      'id'
    ];
    ...
    if (
      this.mainFormGroup.controls.sctrPensionFilePath.value != null &&
      this.mainFormGroup.controls.sctrPensionFilePath.value != ''
    ) {
      pensionAgencyData.FileName =
        'agency-pension-' +
        pensionAgencyData.BrokerId +
        '-' +
        pensionAgencyData.ContractorId +
        '-' +
        pensionAgencyData.AgencyDate.getDate() +
        '-' +
        String(pensionAgencyData.AgencyDate.getMonth() + 1) +
        '-' +
        pensionAgencyData.AgencyDate.getFullYear() +
        '.' +
    ...
    this.agencyService
      .addAgency(pensionAgencyData, this.prepareFile(this.sctrPensionFile))
      .subscribe(
        (res) => {
          if (res.StatusCode == 0) {
            ...
            successList.push(
              'El agenciamiento de SCTR Pensión ha sido exitoso.'
            );
            this.isLoading = false;
          } else {
  ...
  manageAgency() {
    //administrar agenciamiento
    this.isLoading = true;
    if (
      this.mainFormGroup.valid &&
      (this.isSctrPensionSelected == true ||
        this.isSctrSaludSelected == true) &&
      this.contractor.Id != null &&
      this.contractor.Id != '' /*&& (this.sctrPensionFile != undefined)*/
    ) {
      let errorList = [];
      let successList = [];
      let self = this;
      ...
      if (
        this.isSctrSaludSelected &&
        this.isSctrPensionSelected &&
        this.sctrSaludSucceed == false &&
        this.sctrPensionSucceed == false
      ) {
        ...
        saludAgencyData.AgencyDate =
          this.mainFormGroup.controls.saludAgencyDate.value;
        saludAgencyData.ChannelTypeId = this.channelTypeId;
        saludAgencyData.User = JSON.parse(localStorage.getItem('currentUser'))[
          'id'
        ];
        saludAgencyData.ProductId = JSON.parse(localStorage.getItem('saludID'))[
          'id'
        ];

        if (
          this.mainFormGroup.controls.sctrSaludFilePath.value != null &&
          this.mainFormGroup.controls.sctrSaludFilePath.value != ''
        ) {
          saludAgencyData.FileName =
            'agency-salud-' +
            saludAgencyData.BrokerId +
            '-' +
            saludAgencyData.ContractorId +
            '-' +
            saludAgencyData.AgencyDate.getDate() +
            '-' +
            String(saludAgencyData.AgencyDate.getMonth() + 1) +
            '-' +
            saludAgencyData.AgencyDate.getFullYear() +
            '.' +
            this.getFilExtension(
              this.mainFormGroup.controls.sctrSaludFilePath.value
            );
        ...
        this.agencyService
          .addAgency(saludAgencyData, this.prepareFile(this.sctrSaludFile))
          .subscribe(
            (res) => {
              if (res.StatusCode == 0) {
                ...
                successList.push(
                  'El agenciamiento de SCTR Salud ha sido exitoso.'
                );
            ...
            (err) => {
              this.sctrSaludSucceed = false;
              errorList.push(
                'El agenciamiento de SCTR Salud no pudo ser procesado.'
              );
              self.tryToProcessPensionAgency(errorList, successList);
          ...
          .subscribe(
            (res) => {
              if (res.StatusCode == 0) {
                ...
                Swal.fire(
                  'Información',
                  this.createContent(null, errorList, null, null),
                  'error'
                );
              }
            },
        ...
        pensionAgencyData.AgencyDate =
          this.mainFormGroup.controls.pensionAgencyDate.value;
        pensionAgencyData.ChannelTypeId = this.channelTypeId;
        pensionAgencyData.User = JSON.parse(
          localStorage.getItem('currentUser')
        )['id'];
        pensionAgencyData.ProductId = JSON.parse(
          localStorage.getItem('pensionID')
        )['id'];
        let date = new Date();
        date.setDate(pensionAgencyData.AgencyDate.getDate());
        date.setFullYear(pensionAgencyData.AgencyDate.getFullYear());
          ...
          .subscribe(
            (res) => {
              if (res.StatusCode == 0) {
                ...
                Swal.fire(
                  'Información',
                  this.createContent(null, null, null, errorList),
                  'error'
                );
              }
            },
            (err) => {
              errorList.push(
                'El agenciamiento de SCTR Pensión no pudo ser procesado.'
              );
              this.isLoading = false;
              this.sctrPensionSucceed = false;
              Swal.fire(
      ...
      if (this.mainFormGroup.controls.saludAgencyDate.valid == false) {
        if (this.mainFormGroup.controls.saludAgencyDate.hasError('required'))
          errorList.push(
            'La fecha de agenciamiento de Sctr Salud es requerida.'
          );
        else
          errorList.push(
            'La fecha de agenciamiento de Sctr Salud no es válida.'
          );
      }
      if (this.mainFormGroup.controls.pensionAgencyDate.valid == false) {
        if (this.mainFormGroup.controls.pensionAgencyDate.hasError('required'))
          errorList.push(
            'La fecha de agenciamiento de Sctr Pensión es requerida.'
          );
        else
          errorList.push(
            'La fecha de agenciamiento de Sctr Pensión no es válida.'
          );
      }
  ...
  createContent(
    salud_SuccessList: string[],
    salud_ErrorList: string[],
    pension_SuccessList: string[],
    pension_ErrorList: string[]
  ): string {
    let content = '';
    if (
      (salud_SuccessList != null && salud_SuccessList.length > 0) ||
      (salud_ErrorList != null && salud_ErrorList.length > 0)
    ) {
    ...
    content = content + '<br>';
    if (
      (pension_SuccessList != null && pension_SuccessList.length > 0) ||
      (pension_ErrorList != null && pension_ErrorList.length > 0)
    ) {
