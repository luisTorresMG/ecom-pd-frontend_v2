...
export class ContractorLocationFormComponent implements OnInit {
  ...
  @Input() public contractorLocationData: any;
  ...
  ngOnInit() {
    ...
    if (
      this.existentLocationList == null ||
      this.existentLocationList.length == 0
    )
      this.rowToBeIgnored = -1;
    if (this.openedInEditMode == false) {
      //Modo creación
      this.title = 'Creación de sede';
      if (this.contractorLocationData != null)
        this.currentLocation.ContractorId =
          this.contractorLocationData.ContractorId;
      ...
      if (this.willBeSaved == true) {
        ...
        this.currentLocation.Description =
          this.contractorLocationData.Description;
        this.currentLocation.DepartmentId =
          this.contractorLocationData.DepartmentId;
        this.currentLocation.ProvinceId =
          this.contractorLocationData.ProvinceId;
        this.currentLocation.DistrictId =
          this.contractorLocationData.DistrictId;
        ...
        this.activityMain = this.contractorLocationData.Activity;
        this.subActivity = this.contractorLocationData.EconomicActivity;
        this.currentLocation.TechnicalActivityId =
          this.contractorLocationData.TechnicalActivityId;
        this.currentLocation.EconomicActivityId =
          this.contractorLocationData.EconomicActivityId;
        this.currentLocation.UserCode = this.currentUser;
        this.fillContactList();
      } else {
        this.currentLocation.Id =
          this.existentLocationList[this.rowToBeIgnored].Id;
        this.currentLocation.ContractorId =
          this.existentLocationList[this.rowToBeIgnored].ContractorId;
        this.currentLocation.TypeId =
          this.existentLocationList[this.rowToBeIgnored].TypeId;
        this.currentLocation.Description =
          this.existentLocationList[this.rowToBeIgnored].Description;
        this.currentLocation.DepartmentId =
          this.existentLocationList[this.rowToBeIgnored].DepartmentId;
        this.currentLocation.ProvinceId =
          this.existentLocationList[this.rowToBeIgnored].ProvinceId;
        this.currentLocation.DistrictId =
          this.existentLocationList[this.rowToBeIgnored].DistrictId;
        this.currentLocation.Address =
          this.existentLocationList[this.rowToBeIgnored].Address;
        this.currentLocation.StateId =
          this.existentLocationList[this.rowToBeIgnored].StateId;
        this.currentLocation.TechnicalActivityId =
          this.existentLocationList[this.rowToBeIgnored].TechnicalActivityId;
        this.currentLocation.EconomicActivityId =
          this.existentLocationList[this.rowToBeIgnored].EconomicActivityId;
        this.currentLocation.ContactList =
          this.existentLocationList[this.rowToBeIgnored].ContactList;
        this.currentLocation.UserCode = this.currentUser;
        if (
          this.currentLocation.ContactList != null &&
          this.currentLocation.ContactList.length > 0
        )
  ...
  private createFormControl() {
    this.mainFormGroup = this.mainFormBuilder.group({
      ...
      description: ['', [Validators.required, Validators.maxLength(120), GlobalValidators.alphanumericWithSpecialCharsValidator]],
      department: [
        { value: '', disabled: this.openedInEditMode && this.willBeSaved },
        [Validators.required, this.notZeroValueInSelect],
      ],
      province: [
        { value: '', disabled: this.openedInEditMode && this.willBeSaved },
        [Validators.required, this.notZeroValueInSelect],
  ...
  initializeForm() {
    if (this.openedInEditMode == true)
      this.mainFormGroup.controls.type.setValue(this.currentLocation.TypeId);
    else this.mainFormGroup.controls.type.setValue('1');

    this.mainFormGroup.controls.description.setValue(
      this.currentLocation.Description
    );
    this.mainFormGroup.controls.department.setValue(
      this.currentLocation.DepartmentId
    );
    this.mainFormGroup.controls.province.setValue(
      this.currentLocation.ProvinceId
    );
    this.mainFormGroup.controls.district.setValue(
      this.currentLocation.DistrictId
    );
    ...
    this.mainFormGroup.controls.technicalActivity.setValue(
      this.currentLocation.TechnicalActivityId
    );
    this.mainFormGroup.controls.economicActivity.setValue(
      this.currentLocation.EconomicActivityId
    );
  }
  ...
  getEconomicActivityList() {
    if (this.openedInEditMode)
      return this.othersService.getEconomicActivityList(
        this.currentLocation.TechnicalActivityId
      );
    else
      return this.othersService.getEconomicActivityList(
        this.mainFormGroup.controls.technicalActivity.value
      );
  }
  fillEconomicActivityList(event) {
    this.currentLocation.EconomicActivityId = null;
    if (this.currentLocation.TechnicalActivityId != null) {
      if (event != null) {
  ...
  getSubActivity(event) {
    if (this.currentLocation.EconomicActivityId != null) {
      if (event != null) {
  ...
  fillDepartmentList() {
    this.getDepartmentList().subscribe(
      (res) => {
        ...
        if (this.openedInEditMode == true) {
          this.addressService
            .getProvinceList(this.currentLocation.DepartmentId)
            .subscribe(
              (res) => {
                this.provinceList = res;
                this.addressService
                  .getDistrictList(this.currentLocation.ProvinceId)
                  .subscribe(
                    (res) => {
  ...
  getContactList() {
    return this.contractorLocationIndexService.getContractorLocationContactList(
      this.currentLocation.Id,
      this.itemsPerPage,
      1
    );
  ...
  searchContacts() {
    ...
    this.contractorLocationIndexService
      .getContractorLocationContactList(
        this.currentLocation.Id,
        this.itemsPerPage,
        this.currentPage
      )
  ...
  updateContact(_contact: ContractorLocationContactREQUEST) {
    this.contractorLocationIndexService
      .updateContractorLocationContact(_contact)
      .subscribe(
        (res) => {
          if (res.P_NCODE == 0) {
  ...
  updateContractorLocation(_contractorLocation: ContractorLocationREQUEST) {
    ...
    if (_contractorLocation.Description) { //AVS - Trim de descripción
        _contractorLocation.Description = _contractorLocation.Description.trim().replace(/\s+/g, ' ');
    }

    if (this.mainFormGroup.valid) {
      if (this.openedInEditMode == true && this.currentLocation.TypeId == '1') {
        //Consultar si ya se tiene una sede principal activa
        if (this.willBeSaved == true) {
          this.contractorLocationIndexService
            .hasActivePrincipalLocation(
              this.currentLocation.ContractorId,
              this.currentLocation.Id,
              this.currentUser
            )
            .subscribe(
              (res) => {
                if (res.P_NCODE == 1) {
                  Swal.fire(
                    'Información',
                    this.listToString(this.stringToList(res.P_SMESSAGE)),
                    'error'
                  );
                } else if (res.P_NCODE == 2) {
                  Swal.fire(
                    'Información',
                    'Este contratante ya cuenta con una sede principal activa.',
                    'error'
                  );
                } else if (res.P_NCODE == 3) {
                  this.contractorLocationIndexService
                    .updateContractorLocation(_contractorLocation)
                    .subscribe(
                      (subres) => {
                        if (subres.P_NCODE == 0) {
                          Swal.fire(
                          ...
                          Swal.fire(
                            'Información',
                            this.listToString(
                              this.stringToList(subres.P_SMESSAGE)
                            ),
                            'error'
                          );
                        } else if (subres.P_NCODE == 2) {
                          Swal.fire(
                            'Información',
                            this.listToString(
                              this.stringToList(subres.P_SMESSAGE)
          ...
          this.existentLocationList.map(function (existentLocation) {
            if (existentLocation.P_NROW - 1 != self.rowToBeIgnored) {
              if (
                existentLocation.Description ==
                  self.currentLocation.Description.trim() &&
                existentLocation.EconomicActivityId ==
                  self.currentLocation.EconomicActivityId &&
                existentLocation.Address ==
                  self.currentLocation.Address.trim() &&
                existentLocation.DistrictId == self.currentLocation.DistrictId
              )
                existent = 1;
            }
          });
          ...
          if (existent == 0) {
            ...
            Swal.fire(
              'Información',
              'Ya hay una sede con estos datos',
              'error'
            );
          }
        }
        ...
        //Crear nueva Sede
        if (this.willBeSaved == false) {
          // devolvemos la sede y sus clientes
          let existent = 0;
          let self = this;
          this.existentLocationList.map(function (existentLocation) {
            if (existentLocation.P_NROW - 1 != self.rowToBeIgnored) {
      ...
      let errorList = [];
      if (
        this.mainFormGroup.controls.type.hasError('required') ||
        this.mainFormGroup.controls.type.value == '0'
      )
        errorList.push('El tipo de sede es requerido.');
      if (this.mainFormGroup.controls.description.valid == false) {
        if (this.mainFormGroup.controls.description.hasError('required'))
          errorList.push('La descripción es requerida.');
        else errorList.push('La descripción no contiene los caracteres permitidos');
      }
      if (
        this.mainFormGroup.controls.department.hasError('required') ||
        this.mainFormGroup.controls.department.value == 0
      )
        errorList.push('El departamento es requerido.');
      if (
        this.mainFormGroup.controls.province.hasError('required') ||
        this.mainFormGroup.controls.province.value == 0
      )
        errorList.push('La provincia es requerida.');
      if (
        this.mainFormGroup.controls.district.hasError('required') ||
        this.mainFormGroup.controls.district.value == 0
      )
        errorList.push('El distrito es requerido.');
      if (
        this.mainFormGroup.controls.state.hasError('required') ||
        this.mainFormGroup.controls.state.value == '0'
      )
        errorList.push('El estado es requerido.');
      if (this.mainFormGroup.controls.address.valid == false) {
        if (this.mainFormGroup.controls.address.hasError('required'))
          errorList.push('La dirección es requerida.');
        else errorList.push('La dirección no es válida.');
      }
      if (
        this.mainFormGroup.controls.economicActivity.hasError('required') ||
        this.mainFormGroup.controls.economicActivity.value == ''
      )
        errorList.push('La actividad económica es requerida');
      if (
        this.mainFormGroup.controls.technicalActivity.hasError('required') ||
        this.mainFormGroup.controls.technicalActivity.value == ''
      )
        errorList.push('La actividad a realizar es requerida');
  ...
  splitErrorMessage(acumulatedMessage: string): string[] {
    ...
    while (acumulatedMessage.search('-') != -1) {
      if (isFirst == true) {
        isFirst = false;
        acumulatedMessage = acumulatedMessage.substring(
          acumulatedMessage.search('-') + 1
        );
      } else {
        response.push(
          acumulatedMessage.substring(0, acumulatedMessage.search('-'))
        );
        acumulatedMessage = acumulatedMessage.substring(
          acumulatedMessage.search('-') + 1
        );
  ...
  openContactModal(
    ...
    contactData: ContractorLocationContact
  ) {
    const modalRef = this.modalService.open(
      ContractorLocationContactComponent,
      {
        size: 'lg',
    ...
    modalRef.componentInstance.existentContactList =
      this.currentLocation.ContactList;
    ...
    modalRef.result.then(
      (newContactForTable) => {
        if (this.openedInEditMode == true && this.willBeSaved == true) {
          ...
          this.itemsWereFound = true;
          if (this.currentLocation.ContactList == null)
            this.currentLocation.ContactList = [];
  ...
  editContactInView(ind: number) {
    ...
    modalRef.componentInstance.formModalReference = modalRef;
    modalRef.componentInstance.receivedContactData =
      this.currentLocation.ContactList[ind];
  ...
  deleteContact(contactId: number) {
    this.contractorLocationIndexService
      .deleteContact(contactId, this.currentUser)
      .subscribe(
        (res) => {
          this.firstSearch();
          Swal.fire(
