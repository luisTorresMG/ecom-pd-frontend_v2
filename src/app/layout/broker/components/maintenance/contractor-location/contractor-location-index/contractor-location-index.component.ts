...
export class ContractorLocationIndexComponent implements OnInit {
  ...
  */
  ...
  listToShow: any;
  codProducto = JSON.parse(localStorage.getItem('codProducto'))
  ...
  openContractorModal(item: any) {
    const modalRef = this.modalService.open(ContractorViewComponent, {
      size: 'lg',
  ...
  changeValidators() {
    ...
    if (this.mainFormGroup.controls.searchMode.value == '1') {
      ...
      if (this.mainFormGroup.controls.personType.value == '1') {
        this.mainFormGroup.controls['firstName'].setValidators([
          Validators.required,
        ...
        this.mainFormGroup.controls.firstName.updateValueAndValidity();
        this.mainFormGroup.controls['paternalLastName'].setValidators([
          Validators.required,
          Validators.minLength(2),
          Validators.maxLength(19),
          Validators.pattern(GlobalValidators.getLatinTextPattern()),
        ...
        this.mainFormGroup.controls.paternalLastName.updateValueAndValidity();
        this.mainFormGroup.controls['maternalLastName'].setValidators([
          Validators.maxLength(19),
          Validators.pattern(GlobalValidators.getLatinTextPattern()),
          GlobalValidators.vowelLimitValidation,
          GlobalValidators.consonantLimitValidation,
      ...
      if (this.mainFormGroup.controls.searchMode.value == '1') {
        ...
        if (this.mainFormGroup.controls.personType.value == '1') {
          if (this.mainFormGroup.controls.firstName.valid == false) {
            ...
            if (
              this.mainFormGroup.controls.firstName.value == null ||
              this.mainFormGroup.controls.firstName.value.trim() == ''
            ) {
          ...
          if (this.mainFormGroup.controls.paternalLastName.valid == false) {
            if (
              this.mainFormGroup.controls.paternalLastName.hasError('required')
            )
              errorList.push('El apellido paterno es requerido.');
            else errorList.push('El apellido paterno no es válido.');
          } else {
            if (
              this.mainFormGroup.controls.paternalLastName.value == null ||
          ...
          if (this.mainFormGroup.controls.maternalLastName.valid == false) {
            if (
              this.mainFormGroup.controls.maternalLastName.hasError('required')
            )
    ...
    if (this.mainFormGroup.controls.searchMode.value == '1') {
      ...
      if (this.mainFormGroup.controls.personType.value == '1') {
        if (
          ...
          data.P_NIDDOC_TYPE = '';
          data.P_SIDDOC = '';
          data.P_SFIRSTNAME = this.mainFormGroup.controls.firstName.value
            .toString()
            .toUpperCase();
          data.P_SLASTNAME = this.mainFormGroup.controls.paternalLastName.value
            .toString()
            .toUpperCase();
          data.P_SLASTNAME2 =
            this.mainFormGroup.controls.maternalLastName.value == null
              ? ''
              : this.mainFormGroup.controls.maternalLastName.value
                  .toString()
                  .toUpperCase();
          data.P_SLEGALNAME = '';
        } else {
          ...
          this.mainFormGroup.controls.firstName.setValue(
            this.mainFormGroup.controls.firstName.value.trim() == ''
              ? ''
              : this.mainFormGroup.controls.firstName.value
          );
          this.mainFormGroup.controls.paternalLastName.setValue(
            this.mainFormGroup.controls.paternalLastName.value.trim() == ''
              ? ''
              : this.mainFormGroup.controls.paternalLastName.value
          );
          this.isLoadingScreenNotVisible = true;
            ...
            if (res.EListClient.length != 1) {
                  ...
                  if (item != null) {
                    ...
                    if (
                      ...
                      this.currentClient.Address =
                        item.EListAddresClient[0].P_SDESDIREBUSQ;
                    ...
                    if (
                      ...
                      this.currentClient.Phone =
                        item.EListPhoneClient[0].P_SPHONE;
                      ...
                      if (this.documentTypeList.length > 0) {
                        this.documentTypeList.map(function (element) {
                          if (element.Id == item.P_NIDDOC_TYPE)
                            self.currentClient.DocumentType = element.Name;
                        });
                      }

                      let name =
                        item.P_SFIRSTNAME == null ? '' : item.P_SFIRSTNAME;
                      let lastname =
                        item.P_SLASTNAME == null ? '' : item.P_SLASTNAME;
                      let lastname2 =
                        item.P_SLASTNAME2 == null ? '' : item.P_SLASTNAME2;

                      this.currentClient.FullName =
              ...
              if (res.EListClient[0].P_SIDDOC != null) {
                ...
                if (res.EListClient[0].P_NIDDOC_TYPE == '1') {
                  ...
                  let name =
                    res.EListClient[0].P_SFIRSTNAME == null
                      ? ''
                      : res.EListClient[0].P_SFIRSTNAME;
                  let lastname =
                    res.EListClient[0].P_SLASTNAME == null
                      ? ''
                      : res.EListClient[0].P_SLASTNAME;
                  let lastname2 =
                    res.EListClient[0].P_SLASTNAME2 == null
                      ? ''
