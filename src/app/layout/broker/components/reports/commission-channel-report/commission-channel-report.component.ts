...
import { CommissionChannelReportService } from '../../../services/report/commission-channel-report.service';
...
export class CommissionChannelReportComponent implements OnInit {
  // paginacion
  ...
  EventDownload(event) {
    if (this.listCommissionReport.length > 0) {
      this.excelService.exportReportKunturCommissionCF(this.listCommissionReport, 'ReporteComisionKunturCanalVenta');
    } else {
