...
import { SalesEnterpriseReportService } from '../../../services/report/sales-enterprise-report.service';
...
export class SaleEnterpriseReportComponent implements OnInit {
  // paginacion
  ...
  EventDownload(event) {
    if (this.listSalesReport.length > 0) {
      this.excelService.exportReportKunturSalesCF(this.listSalesReport, 'ReporteVentaKunturProtecta');
    } else {
