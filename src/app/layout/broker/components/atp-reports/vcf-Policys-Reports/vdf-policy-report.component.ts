...
export class VcfPolicyReportComponent implements OnInit {
  //CheckBox
          ...
          swal
            ...
            .then((result) => {
              if (result.value) {
                ...
                this.AtpReportService.ProcessVCFPolicyReports(data).subscribe(
                  (res) => {
                    ...
                    if (this.foundResults != null) {
                      ...
                      if (this.totalItems > 0) {
                        if (
                          ...
                          this.excelService.generateReportVigExcelVCF(
                        ...
                        if (
                          ...
                          this.excelService.generateReportAnulExcelVCF(
