...
@Component({
  selector: 'app-descd-operac-report',
  templateUrl: './descd-operac-report.component.html',
  styleUrls: ['./descd-operac-report.component.css'],
})
export class DescdOperacReportComponent implements OnInit {
  //CheckBox
          ...
          swal
            ...
            .then((result) => {
              if (result.value) {
                ...
                this.AtpReportService.ProcessReportsOperac(data).subscribe(
                  (res) => {
                    ...
                    if (this.foundResults != null) {
                      ...
                      if (this.totalItems > 0) {
                        if (
                          ...
                          this.excelService.generateReportOperacVigExcel(
                            this.foundResults.reportVig,
                            'Reporte PólizasVigentes_'
                          );
                        }
                        ...
                        if (
                          ...
                          this.excelService.generateReportOperacAnulExcel(
                            this.foundResults.reportAnnul,
                            'Reporte PólizasAnuladas_'
                          );
                        }
                      } else {
                        swal.fire(
