...
export class VdpRenovationReportComponent implements OnInit {
  //CheckBox
          ...
          swal
            ...
            .then((result) => {
              if (result.value) {
                ...
                this.AtpReportService.VdpRenovationeportVDP(data).subscribe(
                  (res) => {
                    ...
                    if (
                      ...
                      this.excelService.generateReportRenovationExcel(
                        this.foundResults,
                        'ReporteRenovación -'
                      );
                    } else {
