...
export class VdpComisionReportComponent implements OnInit {
  //CheckBox
          ...
          swal
            ...
            .then((result) => {
              if (result.value) {
                ...
                this.AtpReportService.VdpComisionReportVDP(data).subscribe(
                  (res) => {
                    ...
                    if (
                      ...
                      this.excelService.generateReportComisionExcel(
                        this.foundResults,
                        'ProvisionComisionesVDP_'
                      );
                    } else {
                      this.totalItems = 0;
