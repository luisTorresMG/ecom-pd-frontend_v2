...
export class InmobiliaryInterfaceMonitoringService {
    ...
    // CABECERA INTERFACES
    public listarEstados(idata: any): Observable<any> {
        debugger
        const data = JSON.stringify(idata);
        return this.http.post(this.Url + '/InmoInterfaceMonitoring/listarEstados', data, { headers: this.headers });
    }
    ...
    public insertarReprocesoAsi(idata: any): Observable<any> {
        const data = JSON.stringify(idata);
        return this.http.post(this.Url + '/InmoReprocess/InsertarReprocesoAsi', data, { headers: this.headers });
    }
    public insertarReprocesoPlanilla(idata: any): Observable<any> {
        const data = JSON.stringify(idata);
        return this.http.post(this.Url + '/InmoReprocess/InsertarReprocesoPlanilla', data, { headers: this.headers });
    }
